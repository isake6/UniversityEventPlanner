...
const CreateAccount = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.post('https://somethingorother.xyz/create', { firstName, lastName, email, password, role }, { withCredentials: true });
        ...
        <div className="w-1/3 h-fit max-w-xl m-auto bg-white rounded-xl shadow-2xl overflow-hidden flex flex-col justify-center border border-yellow-500">
          <div className="p-5">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <h3 className="text-base font-bold pt-3 text-gray-600">Confirm Password</h3>
              ...
              <div className=' w-full py-6 flex flex-col m-auto'>
                <button type="submit" className='btn btn-info font-bold text-xl bg-yellow-500'>Sign Up</button>
              </div>
            </form>
